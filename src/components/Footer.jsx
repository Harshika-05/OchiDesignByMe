...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 py-20 px-20'>
        <div className='w-1/2 h-full justify-between flex flex-col font-["Founders Grotesk"]'>
        <div className='heading'>
        <h1 className='text-[8vw] uppercase font-semibold font-["Founders Grotesk"]  -mb-10 tracking-tighter'>Eye-</h1>
        <h1 className='text-[8vw] uppercase font-semibold font-["Founders Grotesk"] leading-none -mb-10 tracking-tighter'>Opening</h1>
        </div>
      ...
      <div className='w-1/2'>
      <h1 className='text-[6vw] uppercase font-semibold font-["Founders Grotesk"]  -mb-10 tracking-tighter'>Presentations</h1>
      <div className='dets font-["Neue Montreal"] mt-10 flex justify-around'>
        <div className='first'>
        <h2>S:</h2><br/>
