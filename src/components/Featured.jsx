  ...
  return (
    <div className='w-full py-20'>
      ...
      <div className='cards w-full flex gap-10 mt-25 '>
        ...
        <h1 className='left-full absolute top-1/2 z-[9] -translate-x-1/2 -translate-y-1/2 leading-none tracking-tighter text-6xl font-["Founders Grotesk"] font-semibold flex overflow-hidden text-[#CDEA68] whitespace-nowrap uppercase'>
        ...
        <div className='card w-full h-full rounded-xl overflow-hidden'>
        <h1 className='right-full absolute top-1/2 z-[10] translate-x-1/2 -translate-y-1/2 leading-none tracking-tighter text-6xl font-["Founders Grotesk"] font-semibold  flex overflow-hidden text-[#CDEA68] whitespace-nowrap uppercase'>
      ...
      <div className='px-20'>
      <div className='cards w-full flex gap-10 mt-25 '>
        <motion.div onHoverStart={()=>handleHover(6)} onHoverEnd={() => handleHoverEnd(6)}   className='cardcontainer relative w-1/2 h-[75vh] '>
        <h1 className='left-full absolute top-1/2 z-[9] -translate-x-1/2 -translate-y-1/2 leading-none tracking-tighter text-6xl font-["Founders Grotesk"] font-semibold flex overflow-hidden text-[#CDEA68] whitespace-nowrap uppercase'>
        ...
        <motion.div onHoverStart={()=>handleHover(7)} onHoverEnd={() => handleHoverEnd(7)}   className='cardcontainer relative w-1/2 h-[75vh]'>
        <div className='card w-full h-full rounded-xl overflow-hidden'>
        <h1 className='right-full absolute top-1/2 z-[10] translate-x-1/2 -translate-y-1/2 leading-none tracking-tighter text-6xl font-["Founders Grotesk"] font-semibold flex overflow-hidden text-[#CDEA68] whitespace-nowrap uppercase'>
        {"black_book".split('').map((item , index) => <motion.span key={`blackbook-${index}`} initial = {{y:"100%"}} animate = {cards[7]} transition={{ease : [0.22 , 1 , 0.36 , 1] , delay : index*.05}} className='inline-block'>{item}</motion.span>)}
        </h1>
        <img className='w-full h-full bg-cover ' src="https://ochi.design/wp-content/uploads/2022/06/Frame-3876-1326x1101.jpg" alt = ""/>
        </div>
        </motion.div>
      </div>
      </div>
