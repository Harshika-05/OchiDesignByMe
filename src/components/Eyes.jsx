...
function Eyes() {
  ...
  useEffect(()=>{
    window.addEventListener("mousemove" , (e) =>
    {
      ...
      var angle = Math.atan2(deltaY , deltaX) * (180/Math.PI); //radians to degree conversion
      setRotate(angle-180);
    })
  })
  ...
  return (
    <div className='eyes w-full h-screen overflow-hidden'>
        ...
        <div className='flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-zinc-100'>
          <div className='relative w-2/3 h-2/3 rounded-full bg-zinc-900 flex justify-center items-center text-2xl font-["Neue Montreal"]'>PLAY
